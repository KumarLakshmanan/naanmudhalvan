...
--
-- Host: localhost
-- Generation Time: Apr 12, 2023 at 05:20 AM
...
CREATE TABLE `cheapestelectriccars_evdatabase` (
  ...
  `NumberofSeats` varchar(13) DEFAULT NULL,
...
INSERT INTO `cheapestelectriccars_evdatabase` (`Name`, `Subtitle`, `Acceleration`, `TopSpeed`, `Range`, `Efficiency`, `FastChargeSpeed`, `Drive`, `NumberofSeats`, `PriceinGermany`, `PriceinUK`) VALUES
...
CREATE TABLE `electriccardata_clean` (
  ...
  `AccelSec` varchar(8) DEFAULT NULL,
  `TopSpeed_KmH` varchar(12) DEFAULT NULL,
  `Range_Km` varchar(8) DEFAULT NULL,
  `Efficiency_WhKm` varchar(15) DEFAULT NULL,
  `FastCharge_KmH` varchar(14) DEFAULT NULL,
  ...
  `PriceEuro` varchar(9) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `evindia` (
  ...
  `PriceRange(Lakhs)` varchar(17) DEFAULT NULL,
